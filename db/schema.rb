...
ActiveRecord::Schema.define(version: 20150915200510) do
  ...
  add_index "email_addressees", ["email_id", "type"], name: "index_email_addressees_on_email_id_and_type", using: :btree
